                                ...
                                <Grid align="center" style={formStyle}>
                                    ...
                                    <FormControl component="fieldset">
                                        <RadioGroup row aria-label="campus" name="campus">
                                            <FormControlLabel value="1" control={<Radio />} label="Woluwe" onChange={handleCampusChange}/>
                                            <FormControlLabel value="2" control={<Radio />} label="Ixelles" onChange={handleCampusChange}/>
                                            <FormControlLabel value="3" control={<Radio />} label="Louvain-la-Neuve" onChange={handleCampusChange}/>
                                        </RadioGroup>
                                    </FormControl>
                                    {/* <FormGroup>
                                        <Grid>
